				...
				{show && (
					<Box display={'flex'} flexDirection={'column'} gap={2}>
						<FormControl>
							...
							<Input
								onChange={e => setValue({ ...valu, name: e.target.value })}
								type='text'
								placeholder='ism...'
							/>
						</FormControl>
						<FormControl>
							...
							<Input
								onChange={e => setValue({ ...valu, email: e.target.value })}
								type='email'
								placeholder='email...'
							/>
						</FormControl>
						...
						<FormControl>
							...
							<Input
								onChange={e => setValue({ ...valu, username: e.target.value })}
								type='text'
						...
						<FormControl>
							...
							<Input
								onChange={e => setValue({ ...valu, password: e.target.value })}
								type='password'
								placeholder='parol...'
							/>
						</FormControl>
